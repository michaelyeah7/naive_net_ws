...
if __name__ == '__main__':
    ...
    env = StageWorld(beam_num=360, index=0, num_env=NUM_ENV,ros_port = rosPort,mpi_rank = rank,env_index = envIndex,goal_robotIndex=GOAL_START)
    reward = None
    ...
    if rank == 0:
        ...
        policy_path = 'policy/adv1_naive_network'
        # policy_path = 'policy'
